<?php
    ...
    define (WHAT, '<p>
			...
			<p>
                Uma viagem de moto solitária que começa na Galiza, no extremo noroeste da Península Ibérica,
                e termina no Pireo (Atenas), na Grécia, passando por Portugal, Espanha e Itália (PIGS)*. 
                É um olhar crítico sobre a CRISE.
			</p>
			<p>
                Uma resposta práctica e valente às perguntas que, se não estamos a fazer, deveríamos fazer-nos: 
			</p>
			<ul>
				<li>O que &eacute; a crise?</li>
				<li>De onde vem?</li>
				<li>Até onde nos leva?</li>
				<li>E agora?</li>
			</ul>
			<p>
    ...
    define (WHY, '<p>
                A crise que foi desaceleração e que agora parece uma hecatombe devia ter durado dois anos
                e já vai em seis. Não vemos a luz ao fim do túnel e, se a víssemos, pensaríamos que era
                o comboio que viria para rematar.
			</p>
			<p>
                Temos medo e, como disse o sociólogo britânico Frank Furedi muito antes do surgimento
                da crise, “o medo ubíquo, persistente, gera fatalidade e resignação”. 
			</p>
			<p>
                Precisamos de encontrar outras respostas, outros futuros possíveis, porque
