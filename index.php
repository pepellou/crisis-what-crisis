...
<body>
	...
	<div id="photos">
	<?php 	foreach (getPhotos("pepellou", "music") as $photo) { ?>
			<div class="photo">
				<div name="title"><?php echo $photo['title']; ?></div>
				<div name="link"><?php echo $photo['link']; ?></div>
				<div name="gps">
					<div name="lat"><?php echo $photo['lat']; ?></div>
					<div name="lng"><?php echo $photo['lng']; ?></div>
				</div>
			</div>
	<?php 	} ?>
	</div>
