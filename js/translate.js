var translations = {
	"en": { 
		...
		who: '<p>\
			...
			<p>\
				Accompanying him from Galicia, Irmáns Karapatrov and the collective N&oacute;Com&uacute;n.\
			</p>\
			<p>\
		...
		how: '<p>\
				The project is planned in two different stages:\
				<ol>\
					<li>\
		...
		infoPayment: '<img src="img/icon-battery">\
				<h2>Providing</h2>\
				<div>\
					<ul>\
						<li>\
